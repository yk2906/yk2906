...
> ※ しゅくれんどのバーは仮の目安です。じっさいの得意度に合わせて `■`/`□` の数をあとで調整してください。
...
- 🗺️ **すすこうちゅうのクエスト**: `[ここに記入。例: 〇〇基盤のTerraform化 など]`
...
|---|---|---|
| 📖 | ブログをよむ | `[ここにブログURLを記入]` |
| 🐦 | X (Twitter) をひらく | `[ここにXのURLを記入]` |
| 🌐 | ポートフォリオをみる | `[ここにポートフォリオURLを記入]` |
| 💌 | れんらくする | `[ここに連絡先を記入]` |

*(未入力の項目は準備でき次第うめていきます)*
